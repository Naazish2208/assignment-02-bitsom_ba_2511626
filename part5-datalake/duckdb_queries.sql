-- =============================================================
-- DuckDB Queries — reads directly from raw source files
-- Update the file paths below if running from a different directory
-- =============================================================

-- File references (edit once here if paths change)
